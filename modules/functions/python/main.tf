...
resource "azurerm_function_app" "function-app" {
  ...
  app_settings = {
    ...
    ERROR_STACK="errorStacks"
    REGISTERED_USERS_SHOP_LOG="registeredUsersShopLog"
    REGISTERED_USERS_EMPLOYEES_LOG="registeredUsersEmployeesLog"
    REGISTERED_USERS_WAREHOUSE_LOG="registeredUsersWarehouseLog"
    REGISTERED_USERS_EMPLOYEES_COPY="registeredUsersEmployeesCopy"
    REGISTERED_USERS_LOGIN_DETAILS_LOG="registeredUsersLoginDetailsLog"
    REGISTERED_USERS_PRODUCTS_METADATA_LOG="registeredUsersProductsMetadataLog"
    REGISTERED_USERS_ROLE_BRANCH_DETAILS_LOG="registeredUsersRoleBranchDetailsLog"
    MyConnection : ""
